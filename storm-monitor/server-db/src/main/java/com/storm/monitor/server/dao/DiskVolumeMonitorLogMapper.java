...
/**
 *
 * Title: 【磁盘监控日志表】(对应POJO对象：DiskVolumeMonitorLog)DAO接口类
 * Description: 磁盘监控日志表Dao接口类
 ...
 *
 */
public interface DiskVolumeMonitorLogMapper extends BaseMapper{
        /**
        * 新增一条记录
	...
	public int updateDiskVolumeMonitorLogBySelective(DiskVolumeMonitorLog diskVolumeMonitorLog);
        ...
        * @throws Exception 
        */
	public int queryDiskVolumeMonitorLogByCount(DiskVolumeMonitorLogView diskVolumeMonitorLogView)throws Exception;
