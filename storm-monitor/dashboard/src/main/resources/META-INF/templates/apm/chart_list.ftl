...
<html>
    ...
    <body style="padding: 10px">
        ...
        <div  style="margin:20px 0;">
            <a href="javascript:gotoChartDashboard()" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:false">基于选择构建组合监控图表</a>
        </div>
        <table id="m_buyerror" class="easyui-datagrid" style="width:99%"
               data-options="onDblClickRow:onDblClickRowByDG,fitColumns:true,idField: 'id',rownumbers:true,singleSelect:false,method:'post',selectOnCheck:true,title:'图表配置'">
            <thead>
                <tr>
                    <th data-options="field:'id',checkbox:true,width:60">ID</th>
