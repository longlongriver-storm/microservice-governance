package com.storm.monitor.dashboard.dao;
...
/**
 *
 * Title: 【图表配置】(对应POJO对象：ApmChartConfg)DAO接口类
 ...
 *
 */
public interface ApmChartConfgMapper extends BaseMapper{
        /**
        * 新增一条记录
	...
	public int updateApmChartConfg(ApmChartConfg apmChartConfg)  throws Exception;
        ...
        * @throws Exception 
        */
	public int updateApmChartConfgBySelective(ApmChartConfg apmChartConfg);
