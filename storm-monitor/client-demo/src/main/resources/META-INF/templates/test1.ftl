    ...
    <body>
        ...
        <div class="easyui-panel" style="height:500px;padding:5px;">
            <div id="p" class="easyui-panel" title="事件面板" style="width:600px;height:400px;padding:10px;"
                ...
                <div style="margin-top: 30px">调用返回信息：<span id="msgSpan" style="font-size: x-large;padding: 10px;background-color: #00bbee"></span></div>
                <div style="margin-top: 30px">业务信息：<span id="bizSpan" style="font-size: x-large;padding: 10px;background-color: #00bbee"></span></div>
            </div>
        </div>
