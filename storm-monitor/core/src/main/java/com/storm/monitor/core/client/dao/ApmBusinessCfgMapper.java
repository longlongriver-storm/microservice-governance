package com.storm.monitor.core.client.dao;
...
/**
 *
 * Title: 【apm_business_cfg】(对应POJO对象：ApmBusinessCfg)DAO接口类
 ...
 *
 */
public interface ApmBusinessCfgMapper extends BaseMapper{
        /**
        * 新增一条记录
